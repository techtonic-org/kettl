...
describe("Daily Summary Generator", () => {
  test("getSummaryFilePath returns correct path", async () => {
    setupMocks();
    const { getSummaryFilePath } = await import("./generator");
  ...
  test("summaryExists returns true for existing file", async () => {
    setupMocks();
    const { generateDailySummary, summaryExists } = await import("./generator");
  ...
  test("summaryExists returns false for missing file", async () => {
    setupMocks();
    const { summaryExists } = await import("./generator");
  ...
  test("getSummary returns content for existing file", async () => {
    setupMocks();
    const { generateDailySummary, getSummary } = await import("./generator");
  ...
  test("getSummary returns null for missing file", async () => {
    setupMocks();
    const { getSummary } = await import("./generator");
